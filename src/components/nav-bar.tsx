...
export default function Navbar() {
  ...
  return (
    <header className=" max-w-7xl mx-auto fixed top-1 left-0 right-0 z-50 px-4">
      <nav
        className={`
      ...
      >
        ...
        <div>
          <Link href="#" className="flex items-center gap-1 ">
            ...
            />
            <span className="text-primary  font-bold text-lg   uppercase hidden md:block">
              Aung Myo AYe
            </span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Button className=" group rounded-full" asChild>
            <Link href={"mailto:aungmyoayedev@gmail.com"}>
              <Handshake />
              <span className="hidden sm:inline">Let&apos;s contact</span>
            </Link>
          </Button>
        </div>
      </nav>
