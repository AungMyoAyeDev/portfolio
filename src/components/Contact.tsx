...
const Contact = () => {
  ...
  return (
    ...
    //       >
    //         <svg width="250px" height="250px" viewBox="0 0 24 24" version="1.1">
    //           <motion.path
    ...
    //   </motion.div>
    // </section>
    <section className=" h-screen overflow-hidden relative z-10">
      <h1 className="heading">Contact Me</h1>
      ...
      <motion.div
        className="w-full max-w-2xl mx-auto mt-4 p-8 bg-gray-800 rounded-2xl shadow-2xl space-y-8"
      ...
      >
        ...
        {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              type="submit"
              className="w-full px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-semibold rounded-lg shadow-lg hover:from-teal-600 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-teal-500"
              variants={itemVariants}
